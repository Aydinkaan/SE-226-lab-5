...
bool search_letter(string source, char key_letter) {
    for (int i = 0; i < source.length(); i++) {
        if (source[i] == key_letter) {
            return true;
        }
    }
    return false;
